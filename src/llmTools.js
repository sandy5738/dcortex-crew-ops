...
exports.OPENAI_TOOLS = [
    {
        ...
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.FDP01, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.DUTY02, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.FLT03, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.REST04, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.QUAL05, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.CERT06, { target: "jsonSchema7" })
        }
    },
    {
        type: "function",
        function: {
            ...
            parameters: (0, zod_to_json_schema_1.zodToJsonSchema)(rulesEngine_1.Schemas.BASE07, { target: "jsonSchema7" })
        }
    }
];
// If you want to run this file directly to see what the OpenAI schema looks like:
if (require.main === module) {
    console.log(JSON.stringify(exports.OPENAI_TOOLS[0], null, 2));
}
